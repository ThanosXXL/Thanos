(function () {
  ...
  // keine echte Benutzer-Authentifizierung (siehe Admin-Handbuch).
  const ADMIN_PINS = ['2894', '7059', '0361', '4302'];
  ...
  if (isDemoMode) {
    document.title = 'Inventar - Dashboard – DEMO';
  ...
  async function init() {
    ...
    state = loaded && typeof loaded === 'object' ? loaded : { inventar: [] };
