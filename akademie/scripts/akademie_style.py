...
def chapter_heading(text, kicker=None, subtitle=None):
    """Kapitel-/Abschnittsueberschrift: Glanz-Banner + Logo/Autorenzeile
    darunter. Immer per story.extend(...) statt story.append(...) einfuegen,
    damit beide Flowables gemeinsam eingefuegt werden."""
    return [
        GlossyBanner(text, kicker=kicker, subtitle=subtitle),
        Spacer(1, 0.14 * cm),
        ChapterAttribution(),
    ]
